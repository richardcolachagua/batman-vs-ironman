export const ironmanItems = [
  ...
  },
  {
    ...
    image: "",
    abilities:
      "The Iron Man Armor: Mark III was Tony Starks third Iron Man suit and an upgrade from the Mark II, improving on its previous flaws. It was the first suit to integrate an advanced on-board weapons system and was the first to adopt the classic red and gold color scheme.",
  },
  {
    id: 5,
    name: "Mark I-VII",
  ...
  },
  {
    ...
    image: "",
    abilities:
      "The original Iron Man suits, culminating in the classic red and godl suit.",
  },
